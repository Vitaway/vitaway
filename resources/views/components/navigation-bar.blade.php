      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <div class="mt-4">
                <a href="{{ route('contact') }}" class="py-3 px-7 text-base font-medium text-dark hover:text-primary">
                  About Us
                </a>
                <a href="{{ route('contact') }}" class="rounded-lg bg-[#3268b9] py-2.5 px-7 text-base font-medium text-white hover:bg-opacity-90">
                  Contact
                </a>
            </div>
