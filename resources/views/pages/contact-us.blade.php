...
@section('metas')
    ...
    <meta name="description"
        content="Contact Vitaway for all your healthcare needs. Reach our dedicated team for product information, support, or partnership inquiries. Your message matters to us. Let's connect for a healthier tomorrow.">
    <meta name="keywords"
        content="contact Vitaway, healthcare team, product information, support, partnership inquiries, healthcare needs">
@stop
            ...
            <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div class="flex flex-col items-center justify-between xl:flex-row">
                    <div class="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12">
                        <h2
                            class="max-w-lg mb-6 font-sans text-3xl font-normal font-patua tracking-tight text-white sm:text-4xl sm:leading-none">
                            Contact Vitaway today, and let's connect for <span
                                class="text-gray-400 font-normal font-patua">a Healthier tomorrow</span>
                        </h2>
                        ...
                        <div class="col-lg-12 more-detail-buttons mt-4">
                            <a href="https://wa.me/250787279560" rel="noopener" target="__blank">
                                <button type="button"
                                    class="text-white font-patua font-normal bg-green-600 hover:bg-green-600/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 rounded-lg text-md px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 mr-2 mb-2">
                                    Use Whatsapp
                                </button>
                            </a>
                            <a href="{{ route('get.download') }}">
                                <button type="button"
                                    class="text-gray-900 font-patua font-normal bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 rounded-lg text-md px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 mr-2 mb-2">
                                    Download The app
                                </button>
                            </a>
                        </div>
                    ...
                    <div class="w-full max-w-xl xl:px-8 xl:w-5/12">
                        <div class="relative">
                            <svg viewBox="0 0 52 24" fill="currentColor"
                                class="absolute bottom-0 right-0 z-0 hidden w-32 -mb-8 -mr-20 text-gray-300 lg:w-32 lg:-mr-16 sm:block">
                                <defs>
